    ...
    <div class="header">
      ...
      <div class="header-right">
        ...
        <div class="function-area">
          ...
          <el-button :icon="Service" circle type="primary" @click="handleConnect"></el-button>
          <el-button :icon="SwitchButton" circle type="danger" @click="handleClose"></el-button>
        </div>
      </div>
    </div>
    <div class="content">
      <el-table :data="store.data" :height="tableHeight" border style="width: 100%">
        ...
        <el-table-column fixed="right" prop="image_sno" label="图像冠字号码结构" align="center">
        </el-table-column>
      </el-table>
    </div>
  </div>
